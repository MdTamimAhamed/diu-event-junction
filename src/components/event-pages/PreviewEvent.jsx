				...
				<div className='flex justify-evenly bg-primary h-[320px]'>
					<div className='max-w-4xl mt-20 h-[150vh]'>
						<img
							...
							src={`${baseUrl}/uploads/${previewEventData.eventThumbnail}`}
							alt='event thumbnail'
						/>

						<div className='flex mt-16'>
							<p className='text-red '>Up comming event</p>
							<p className='border-[1px] border-secondary text-secondary ml-4 px-6'>
						...
						<div className='flex justify-between'>
							...
							<div className='  mt-2 w-[65%] '>
								<div className='border-l-4 border-secondary'>
									<h1 className=' font-extrabold text-2xl leading-7 ml-2'>
								...
								<div className='mt-10'>
									...
									{previewEventData.speaker.map((item, index) => (
										<p
											key={index}
											className='flex items-center text-gray list-disc font-lato'>
											<GoDotFill className='text-sm mr-2 text-secondary' />
											{item}
										</p>
									))}
								</div>
							...
							<div className='w-[31%]'>
								...
								<div className='flex justify-between w-full [&>div]:bg-white [&>div]:shadow-md [&>div]:w-12 [&>div]:h-10'>
									<div className='relative rounded'>
										<span className=' absolute text-lg font-bold top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%]'>
											{days}d
										</span>
									</div>
									<div className='relative rounded'>
								...
								<div className='border-l-[1px] border-[rgba(0,0,0,0.1)]'>
									<div className='pl-6'>
										...
										<div className='flex text-sm '>
											...
											<span className='font-medium flex'>
												...
												<span className='pl-2'>
													...
													<p className=' font-normal'>
														<span className='font-medium text-red'>End:</span>{' '}
														{day2} {endDate}
													</p>
												</span>
											</span>
										...
										<div className='flex  mt-[6px]'>
											...
											<p className='font-medium justify-between text-sm'>
												Venue:
