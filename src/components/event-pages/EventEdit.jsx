...
function EventEdit() {
  ...
  async function handleUpload(e){
    ...
    if(file){formData.append('eventThumbnail', file)}
  ...
  useEffect(() => {
    if (updateEventData){
      ...
      setEventStartDate(updateEventData.dates)
          ...
          <>
            <form onSubmit={handleUpload} encType="multipart/form-data"
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="">
                      <div className="text-xl font-medium text-red">Edit Event</div>
                      <p className="text-sm text-gray">Update event here...</p>
                    </div>
                  </div>
                      ...
                      <div className="mt-5 w-full flex justify-between flex-wrap">
                        <div className="flex justify-between pr-10 ">
                          ...
                          <div className="ml-10">
                            ...
                            />
                            <p className='mb-4  text-light-gray'>Previous start: {updateEventData.dates[0]}</p>
                            ...
                            />
                            <p className='mb-4  text-light-gray'>Previous end: {updateEventData.dates[1]}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex">
                          ...
                          <div className="ml-10">
                            ...
                            />
                            <p className='mb-4  text-light-gray'>Previous start: {updateEventData.times[0]}</p>
                            ...
                            />
                            <p className='mb-4  text-light-gray'>Previous start: {updateEventData.times[1]}</p>
                          </div>
                        </div>
                      </div>
