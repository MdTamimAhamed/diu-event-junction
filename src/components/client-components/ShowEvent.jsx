    ...
    <>
      <div>
            ...
            <div className=''>
                ...
                <div className='relative max-w-4xl -mt-44 h-auto mb-20  mx-auto'>
                    <img 
                        ...
                        <div className='border-l-[1px] border-[rgba(0,0,0,0.1)]'>
                            <div className='pl-6'>
                                ...
                                <div className='flex justify-between items-center text-white mt-8'>
                                  <button className='flex justify-center items-center basis-[48%] bg-secondary py-2 rounded'>
                                    <FaStar className='text-white mr-2'/> Interested
                                  </button>
                                  <button className='flex justify-center items-center basis-[48%] bg-primary py-2 rounded'>
                                    <FaHeart className='text-white mr-2'/>Favorite
                                  </button>
                                </div>

                                <div>
                                  <button className='bg-black text-white py-2 w-full mt-[10px] rounded'>Registration Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
